...
class ParserTest extends TestCase
{
    ...
    public function testNewlineBeforeAnIncludedIsntGobbled() : void
    {
        ...
        self::assertInstanceOf('phpDocumentor\Guides\RestructuredText\Nodes\SectionBeginNode', $nodes[0]);
        self::assertInstanceOf('phpDocumentor\Guides\RestructuredText\Nodes\TitleNode', $nodes[1]);
        self::assertInstanceOf('phpDocumentor\Guides\RestructuredText\Nodes\ParagraphNode', $nodes[2]);
        self::assertInstanceOf('phpDocumentor\Guides\RestructuredText\Nodes\ParagraphNode', $nodes[3]);
    ...
    public function testIncludesKeepScope() : void
    {
        ...
        self::assertInstanceOf('phpDocumentor\Guides\RestructuredText\Nodes\QuoteNode', $nodes[3]);
